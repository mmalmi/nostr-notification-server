...
pub mod subscription {
    ...
    impl<'a> WebPushSubscription<'a> {
        ...
        >(
            ...
            if let Some(x) = args.p256dh {
                builder.add_p256dh(x);
            }
        ...
        pub fn endpoint(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                    WebPushSubscription::VT_ENDPOINT,
                    None,
                )
            }
        }
        ...
        pub fn auth(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(WebPushSubscription::VT_AUTH, None)
            }
        }
        #[inline]
        pub fn p256dh(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(WebPushSubscription::VT_P256DH, None)
            }
        }
    }
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> WebPushSubscriptionBuilder<'a, 'b, A> {
        ...
        pub fn add_auth(&mut self, auth: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(WebPushSubscription::VT_AUTH, auth);
        }
        #[inline]
        pub fn add_p256dh(&mut self, p256dh: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                WebPushSubscription::VT_P256DH,
                p256dh,
            );
        }
        #[inline]
        ...
        ) -> WebPushSubscriptionBuilder<'a, 'b, A> {
    ...
    impl<'a> Tag<'a> {
        ...
        pub fn key(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Tag::VT_KEY, None)
            }
        }
        #[inline]
        pub fn values(
    ...
    impl<'a> SubscriptionFilter<'a> {
        ...
        >(
            ...
            if let Some(x) = args.search {
                builder.add_search(x);
            }
            if let Some(x) = args.kinds {
                builder.add_kinds(x);
            }
            if let Some(x) = args.authors {
                builder.add_authors(x);
            }
        ...
        pub fn ids(
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>,
                >>(SubscriptionFilter::VT_IDS, None)
            }
        }
        #[inline]
        pub fn authors(
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>,
                >>(SubscriptionFilter::VT_AUTHORS, None)
            }
        }
        #[inline]
        ...
        pub fn search(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(SubscriptionFilter::VT_SEARCH, None)
            }
        }
        #[inline]
        pub fn tags(
            ...
            unsafe {
                ...
                >>(SubscriptionFilter::VT_TAGS, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for SubscriptionFilter<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>,
                >>("ids", Self::VT_IDS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>,
                >>("authors", Self::VT_AUTHORS, false)?
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SubscriptionFilterBuilder<'a, 'b, A> {
        ...
        pub fn add_ids(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(SubscriptionFilter::VT_IDS, ids);
        }
        #[inline]
        pub fn add_authors(
            &mut self,
            authors: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<&'b str>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                SubscriptionFilter::VT_AUTHORS,
                authors,
            );
        }
        #[inline]
        pub fn add_kinds(&mut self, kinds: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u16>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(SubscriptionFilter::VT_KINDS, kinds);
        }
        #[inline]
        pub fn add_search(&mut self, search: flatbuffers::WIPOffset<&'b str>) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                SubscriptionFilter::VT_SEARCH,
                search,
            );
        }
        #[inline]
        pub fn add_tags(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(SubscriptionFilter::VT_TAGS, tags);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> SubscriptionFilterBuilder<'a, 'b, A> {
            let start = _fbb.start_table();
    ...
    impl<'a> Subscription<'a> {
        ...
        >(
            ...
            if let Some(x) = args.subscriber {
                builder.add_subscriber(x);
            }
            if let Some(x) = args.filter {
                builder.add_filter(x);
            }
            if let Some(x) = args.web_push_subscriptions {
                builder.add_web_push_subscriptions(x);
            }
        ...
        pub fn webhooks(
            ...
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>,
                >>(Subscription::VT_WEBHOOKS, None)
            }
        }
        #[inline]
        pub fn web_push_subscriptions(
            &self,
        ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<WebPushSubscription<'a>>>>
        {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<WebPushSubscription>>,
                >>(Subscription::VT_WEB_PUSH_SUBSCRIPTIONS, None)
            }
        }
        #[inline]
        pub fn filter(&self) -> Option<SubscriptionFilter<'a>> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<SubscriptionFilter>>(
                        Subscription::VT_FILTER,
                        None,
                    )
            }
        }
        ...
        pub fn subscriber(&self) -> Option<&'a str> {
            ...
            unsafe {
                self._tab
                    .get::<flatbuffers::ForwardsUOffset<&str>>(Subscription::VT_SUBSCRIBER, None)
            }
        }
    }
    ...
    impl flatbuffers::Verifiable for Subscription<'_> {
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<&'_ str>>,
                >>("webhooks", Self::VT_WEBHOOKS, false)?
                .visit_field::<flatbuffers::ForwardsUOffset<
                    flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<WebPushSubscription>>,
                >>(
                    "web_push_subscriptions",
                    Self::VT_WEB_PUSH_SUBSCRIPTIONS,
                    false,
                )?
                .visit_field::<flatbuffers::ForwardsUOffset<SubscriptionFilter>>(
                    "filter",
                    Self::VT_FILTER,
                    false,
                )?
    ...
    pub struct SubscriptionArgs<'a> {
        pub webhooks: Option<
            flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>,
        >,
        pub web_push_subscriptions: Option<
            flatbuffers::WIPOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<WebPushSubscription<'a>>>,
            >,
        >,
    ...
    impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SubscriptionBuilder<'a, 'b, A> {
        ...
        pub fn add_webhooks(
            ...
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<_>>(Subscription::VT_WEBHOOKS, webhooks);
        }
        #[inline]
        pub fn add_web_push_subscriptions(
            &mut self,
            web_push_subscriptions: flatbuffers::WIPOffset<
                flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<WebPushSubscription<'b>>>,
            >,
        ) {
            self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
                Subscription::VT_WEB_PUSH_SUBSCRIPTIONS,
                web_push_subscriptions,
            );
        }
        #[inline]
        pub fn add_filter(&mut self, filter: flatbuffers::WIPOffset<SubscriptionFilter<'b>>) {
            self.fbb_
                .push_slot_always::<flatbuffers::WIPOffset<SubscriptionFilter>>(
                    Subscription::VT_FILTER,
                    filter,
                );
        }
    ...
    pub fn root_as_subscription(
        buf: &[u8],
    ) -> Result<Subscription, flatbuffers::InvalidFlatbuffer> {
    ...
    pub fn size_prefixed_root_as_subscription(
        buf: &[u8],
    ) -> Result<Subscription, flatbuffers::InvalidFlatbuffer> {
    ...
    #[inline]
    pub fn finish_size_prefixed_subscription_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
        fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
        root: flatbuffers::WIPOffset<Subscription<'a>>,
    ) {
